...
<xsl:for-each select="element">
	<xsl:sort select="dwhen" data-type="number" order="descending"/>
	...
	<![CDATA[<dict>]]>
		...
		<xsl:otherwise><![CDATA[<string>]]><xsl:value-of select="dwhen"/>, <xsl:value-of select="dwhere"/><![CDATA[</string>]]></xsl:otherwise>
		</xsl:choose>
	<![CDATA[</dict>]]>
</xsl:for-each>
<![CDATA[</array>]]>

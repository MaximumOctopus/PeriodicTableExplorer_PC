...
<xsl:template match="element">	
	...
	<xsl:document href="{concat('pages\',$boing, '.htm')}">
		...
		<tr bgcolor="#F0EDED">
    	  <td height="18" class="PF"><div align="center"><A HREF="..\compound\{an}.htm">Compounds</A> | <B>Reactions</B> | <A HREF="..\production\{an}.htm">Production</A> | <A HREF="..\video\s{an}.htm">Video</A></div></td>
	    </tr>
		<tr bgcolor="#F0EAEA">

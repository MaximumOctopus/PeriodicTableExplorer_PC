...
<xsl:template match="elementbiog">
	...
	.JQ {font-family: Verdana; font-size:6pt; color:#444444;}
	</xsl:comment>
	</style></HEAD>
		...
		<xsl:if test="@type='entry'">
			<xsl:choose>
				<xsl:when test="position() mod 2 = 1">
					...
					<SPAN class="JF">&nbsp;&nbsp;<img src="bluecube.gif"/><a href="biography\{ab}.htm"><xsl:value-of select="bentry"/></a></SPAN>&nbsp;<SPAN class="JQ">(<xsl:value-of select="birth"/>)</SPAN></td></tr>
				</xsl:when>		
				<xsl:otherwise>
					<tr><td>
					<SPAN class="JF">&nbsp;&nbsp;<img src="bluecube.gif"/><a href="biography\{ab}.htm"><xsl:value-of select="bentry"/></a></SPAN>&nbsp;<SPAN class="JQ">(<xsl:value-of select="birth"/>)</SPAN></td></tr>
